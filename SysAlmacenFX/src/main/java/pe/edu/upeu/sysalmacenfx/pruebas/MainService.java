...
public class MainService {
    ...
    public void registro() {
        ...
        while (true) {
            ...
            Categoria guardada = service.save(categoria);
    ...
    public void actualizar() {
        try {
            ...
            Categoria categoriaExistente = service.buscarId(idModificar);
            ...
            service.save(categoriaExistente);
